 ...
 * 自定义Oauth2异常类反序列化类
 */
public class GlobalOAuth2ExceptionJackson2Deserializer extends StdDeserializer<OAuth2Exception> {

    public GlobalOAuth2ExceptionJackson2Deserializer() {
        super(OAuth2Exception.class);
    }

    @Override
    public OAuth2Exception deserialize(JsonParser jp, DeserializationContext deserializationContext) throws IOException,
