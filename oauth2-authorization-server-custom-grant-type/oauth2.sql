...
-- ----------------------------
INSERT INTO `oauth_client_details` VALUES ('client1', NULL, '$2a$10$/Ci6DDwsvM6/dk9XOkPivuCCX.5WCLDM2H4VchKLyee4NIZdIVapW', 'user_base', 'authorization_code,password,client_credentials,implicit,refresh_token,captcha,sms_code', 'http://localhost:8888/callback', NULL, 300, 1500, NULL, 'false');
